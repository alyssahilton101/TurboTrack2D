...
public class HqRenderer : MonoBehaviour
{
    ...
    [SerializeField] UnityEvent onHazard;
    [SerializeField] UnityEvent offHazard;
    [SerializeField] int testPos;
    ...
    public void drawSprite(ref Line line)
    {
        ...
        ////////////////////////////////////////////
        if ((line.spriteX - 0.25 <= playerX && line.spriteX + 0.25 >= playerX) && (line.W - 20 <= 220 && line.W + 20 >= 220)) {

            if (line.isHazard) onHazard.Invoke();
            else onColision.Invoke();
